...
- clicking on a heading opens a detailed screen with the whole news text, bigger picture and
meta data as author, create date etc
- the data for the news is **fetched from online news** feed (example https://newsapi.org/ )
- on top of main screen, there is a **Search field**, that will dynamically filter the news by the
typed word
